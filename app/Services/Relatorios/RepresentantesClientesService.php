...
class RepresentantesClientesService extends DefaultService
{
    protected RelatoriosRepository $relatorios_repository;
    protected string $mensagem_nao_encontrada = 'Representantes para o cliente não foram encontrados. Tente novamente.';
    ...
    {
        try {
            $resposta_db = $this->relatorios_repository->representantes_clientes_db($id);
